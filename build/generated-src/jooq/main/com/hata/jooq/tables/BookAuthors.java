...
public class BookAuthors extends TableImpl<BookAuthorsRecord> {
    ...
    /**
     * The column <code>public.book_authors.author_order</code>.
     */
    public final TableField<BookAuthorsRecord, Integer> AUTHOR_ORDER = createField(DSL.name("author_order"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("1"), SQLDataType.INTEGER)), this, "");
