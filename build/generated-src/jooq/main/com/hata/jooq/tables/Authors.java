 ...
 */
package com.hata.jooq.tables;


import com.hata.jooq.Keys;
import com.hata.jooq.Public;
import com.hata.jooq.tables.BookAuthors.BookAuthorsPath;
import com.hata.jooq.tables.Books.BooksPath;
import com.hata.jooq.tables.records.AuthorsRecord;
...
public class Authors extends TableImpl<AuthorsRecord> {
     ...
     */
    public final TableField<AuthorsRecord, String> NAME = createField(DSL.name("name"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.authors.birth_date</code>.
     */
    public final TableField<AuthorsRecord, OffsetDateTime> BIRTH_DATE = createField(DSL.name("birth_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");

    /**
     * The column <code>public.authors.created_at</code>.
     */
    public final TableField<AuthorsRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");

    /**
     * The column <code>public.authors.updated_at</code>.
     */
    public final TableField<AuthorsRecord, OffsetDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    public List<UniqueKey<AuthorsRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UQ_AUTHORS_NAME_BIRTH_DATE);
    }
    ...
    public List<Check<AuthorsRecord>> getChecks() {
        return Arrays.asList(
            Internal.createCheck(this, DSL.name("ck_authors_birth_date"), "((((birth_date AT TIME ZONE 'Asia/Tokyo'::text))::date < ((now() AT TIME ZONE 'Asia/Tokyo'::text))::date))", true)
        );
    }
