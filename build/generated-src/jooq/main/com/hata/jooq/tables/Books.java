...
import com.hata.jooq.tables.Authors.AuthorsPath;
...
public class Books extends TableImpl<BooksRecord> {
     ...
     */
    public final TableField<BooksRecord, String> TITLE = createField(DSL.name("title"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.books.price</code>.
     */
    public final TableField<BooksRecord, BigDecimal> PRICE = createField(DSL.name("price"), SQLDataType.NUMERIC(12, 2).nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.NUMERIC)), this, "");

    /**
     * The column <code>public.books.status</code>.
     */
    public final TableField<BooksRecord, PublicationStatus> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR.nullable(false).defaultValue(DSL.field(DSL.raw("'UNPUBLISHED'::publication_status"), SQLDataType.VARCHAR)).asEnumDataType(PublicationStatus.class), this, "");
    ...
    public List<Check<BooksRecord>> getChecks() {
        return Arrays.asList(
            Internal.createCheck(this, DSL.name("books_price_check"), "((price >= (0)::numeric))", true)
        );
    }
